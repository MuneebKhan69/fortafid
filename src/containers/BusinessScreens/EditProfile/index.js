...
class EditProfile extends Component {
  state = {
    ...
    driversLicense: this.props.user?.driversLicense,
    licenseNumber: this.props.user?.licenseNumber,
    address: this.props.user?.address,
    bankingInfo: this.props.user?.bankingInfo,
    userImage: this.props.user?.image,
    insurancePolicyNumber: this.props.user?.insurancePolicyNumber,
    insuranceExpiryDate: this.props.user?.insuranceExpiryDate,
    selectedImage: null,
    showDOB: false,
    newCities: [],
  };
      ...
      <AppBackground title={'Edit Profile'} back>
        <ScrollView
          ...
          <View style={{alignItems: 'center', alignSelf: 'center'}}>
            ...
            />
            {/* <ProfileTextInput
              onChangeText={value => this.setState({bankingInfo: value})}
            ...
            <CustomButton
              ...
              onPress={() => {
                this.props.saveUser({
                  ...this.props?.user,
                  name,
                  image: selectedImage ? selectedImage.path : userImage,
                  bio,
                  licenseNumber,
                  driversLicense,
                  state,
